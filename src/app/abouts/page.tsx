...
export default function AboutPage() {
  ...
  return (
    <main>
      <section className="sm:ml-12 grid sm:grid-cols-3 gap-1 sm:pt-35 pt-30">
        {/* Hero Section */}
      ...
      <section className="grid sm:grid-cols-2 gap-1 sm:pt-10 pt-30">
        {/* Team Section */}
        <div className="sm:ml-40 p-6 sm:col-span-1 top-32 h-[85vh] scrollbar-hide order-2 sm:order-1">
          <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-2 gap-6 max-w-3xl mx-auto">
        ...
        {/* Hero Section */}
        <div className="relative sm:mr-12 px-4 sm:px-8 py-8 order-1 sm:order-2">
          <div className="bg-gradient-to-r from-white to-orange-50 rounded-[35%_100%_85%_100%_/_100%_78%_100%_90%] shadow-xl sm:shadow-2xl p-5 sm:p-3 text-center sm:text-left max-w-2xl ">
            <h1 className=" fira-sans-semibold-italic text-3xl sm:text-2xl md:text-6xl font-extrabold tracking-tight text-blue-950 leading-tight">
              <span className="bg-gradient-to-r from-amber-900 via-amber-700 to-amber-500 bg-clip-text text-transparent">
                Faculty Coordinator
              </span>
