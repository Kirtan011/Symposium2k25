...
const techEventData = [
  {
    ...
    formLink: "https://forms.gle/VjJn185ffA2yBC4y7",
    rules: [
      "-----------------------------",
      "💻 Round 1: MCQs",
      "-----------------------------",
  ...
  },
  {
    ...
    formLink:
      "https://docs.google.com/forms/u/3/d/e/1FAIpQLScyzFgjHlzQFURYKZ6fhoJP4T5JeKp6uyVa3ySubiD8w4wmyw/viewform?usp=header",
    rules: [
      "------------------------------------------",
...
const preEventData = [
  {
    id: "Kalp-Kala",
    img: "/Posters/Pre_KalpKala.jpg",
    tagline: "From Tissue to Treasure.",
    formLink: "https://forms.gle/SDQQLHhpWDEKgRhV7",
    rules: [
      "-----------------------------",
      "🌸✨KALP KALA - Tissue Art Workshop ✨🌸",
      "-----------------------------",
      "   • A creative pre-workshop for SYMPOSIUM 2K25",
      "   • Unfold your imagination with colors & textures 🧻🌈",
      "-----------------------------",
      "💡 Highlights",
      "-----------------------------",
      "   • Hands-on tissue art session",
      "   • Guided learning in a fun way",
      "   • All materials will be provided",
      "-----------------------------",
      "🌍 Theme: “From Stone to Silicon”",
      "-----------------------------",
      "   • Tracing communication from 🪨 caves ➡️ 💻 digital age",
      "-----------------------------",
      "-----------------------------",
  ...
  {
    id: "Robo-Juniors-Workshop",
    img: "/Posters/Pre_Robo.jpg",
    tagline: "From Vision to Motion!",
    formLink: "https://tinyurl.com/3sby6vmu",
    rules: [
      "-----------------------------",
      "🤖🚀 ROBO JUNIORS WORKSHOP 🚀🤖",
      "-----------------------------",
      "   Organized by Electronics & Communication Engineering Dept. & ESRO Club, SCET",
      "-----------------------------",
      "   Unlock the world of Robotics & Innovation!",
      "   Learn everything from basic electronics, motor control,",
      "   and building wired robots – all in one workshop! 💡⚡",
      "-----------------------------",
      "📅 Date: 13th September 2025",
      "🕘 Time: 9:30 AM onwards",
      "📍 Venue: EC AV Room",
      "-----------------------------",
      "💡 Learn, Build & Explore Robotics with hands-on experience!",
      "-----------------------------",
      "💰 Kit Price: ₹1000 (4-Wheel Robot Kit)",
      "-----------------------------",
      "💰 Registration Fees:",
      "   • ₹100 (Without Kit)",
      "   • FREE (With Kit purchase)",
      "-----------------------------",
      "👉 Register now & gear up for innovation!",
    ],
  },
  {
    id: "SympoScreen",
    img: "/Posters/Pre_SympoScreen.jpg",
    tagline: "Capture.Create.Captivate.",
    formLink: "https://forms.gle/6q6KQk9FbYGaMZAP8",
    rules: [
      "1️⃣ Reels must reflect Symposium Theme",
      "2️⃣ Duration: 30-60 sec only",
      "3️⃣ Original work - no plagiarism",
      "4️⃣ Submit in MP4/MOV (HD min 720p)",
      "5️⃣ Language: English/Hindi/Regional (with subtitles preferred)",
      "6️⃣ Team of 2 to 5 members",
      "7️⃣ Keep content clean, respectful & creative",
      "8️⃣ Judging based on:",
      "   ✨ Creativity (40%)",
      "   🎯 Theme Relevance (30%)",
      "   🎥 Quality (20%)",
      "   🔥 Impact (10%)",
      "9️⃣ Organizers will feature 3 winning reels on official platforms",
      "🔟 Deadline:",
      "   • 14st SEPTEMBER – 11:59 PM IST for SYMPOBUZZ",
      "   • 20th SEPTEMBER – 3:00 PM IST for SYMPOREWIND",
      "   🏆 Top 3 reels will be officially featured on Symposium platforms!",
    ],
  },
];
...
export { EventCard, preEventData, nonTechEventData, techEventData };
